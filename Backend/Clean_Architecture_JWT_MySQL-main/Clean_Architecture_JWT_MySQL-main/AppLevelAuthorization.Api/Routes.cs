...
public static class Routes
{
    ...
    {
        public const string User = Base + "/timetable/user";
        public const string Supervisor = Base + "/timetable/supervisor";
        public const string Manager = Base + "/timetable/manager";
        public const string Admin = Base + "/timetable/admin";
    }
}